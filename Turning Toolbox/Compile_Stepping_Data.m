...
Filename2 = sprintf(char(strcat(ExpName,{' '},'Stepping Data - SPSS.xlsx')));
...
load(char(strcat(ExpName,{' '},ParticipantID,{' '},'Stepping Data.mat')));
...
Filename = sprintf(char(strcat(ExpName,{' '},'Stepping Data - Direction Collapsed.xlsx')));
Filename2 = sprintf(char(strcat(ExpName,{' '},'Stepping Data - Direction Collapsed - SPSS.xlsx')));
...
load handel
sound(y,Fs);
h = msgbox('Compile Stepping Data Script Complete');
clear