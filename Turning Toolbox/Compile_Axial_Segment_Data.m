...
for j = 1:3
    ...
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Dis Max'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Dis Max'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Dis Max'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Dis MaxTime'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Dis MaxTime'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Dis MaxTime'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Dis Range'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Dis Range'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Dis Range'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Dis SD'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Dis SD'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Dis SD'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Dis RMS'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Dis RMS'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Dis RMS'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Vel Max'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Vel Max'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Vel Max'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Vel MaxTime'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Vel MaxTime'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Vel MaxTime'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Vel SD'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Vel SD'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Vel SD'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Vel RMS'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Vel RMS'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Vel RMS'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Acc Max'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Acc Max'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Acc Max'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Acc MaxTime'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Acc MaxTime'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Acc MaxTime'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Acc SD'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Acc SD'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Acc SD'));
    Heading = horzcat(Heading,strcat('Head',{' '},Direction,{' '},'Acc RMS'));
    Heading = horzcat(Heading,strcat('Thorax',{' '},Direction,{' '},'Acc RMS'));
    Heading = horzcat(Heading,strcat('Pelvis',{' '},Direction,{' '},'Acc RMS'));
end
%Intersegmental
for j = 1:3
    if j == 1;
    ...
    for k = 1:3
        ...
        Heading = horzcat(Heading,strcat(Relationship,{' '},Direction,{' '},'Dis Max'));
        Heading = horzcat(Heading,strcat(Relationship,{' '},Direction,{' '},'Dis MaxTime'));
        Heading = horzcat(Heading,strcat(Relationship,{' '},Direction,{' '},'AI'));
        Heading = horzcat(Heading,strcat(Relationship,{' '},Direction,{' '},'CC Coeff'));
...
if TF==1
    ...
    Filename = sprintf(char(strcat(ExpName,{' '},'Axial Segment Data - Direction Collapsed.xlsx')));
    Filename2 = sprintf(char(strcat(ExpName,{' '},'Axial Segment Data - Direction Collapsed - SPSS.xlsx')));
    ...
    for j = 1:8;
        u = genvarname('AllCollapsedMeansCondition', who); %#ok<*DEPGENAM>
...
load handel
sound(y,Fs);
disp('Compile Axial Segment Data Script Complete');
clear