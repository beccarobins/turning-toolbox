...
HeadingExport = horzcat({'Onset Position'},{'End Position'},{'Amplitudes'},{'Velocities'},{'Accelerations'});
...
for k = 1:NumParticipants;
    ...
    load(char(strcat(ExpName,{' '},ParticipantID,{' '},'Individual Fast Phases.mat')));
...
load handel
sound(y,Fs);
dips('Compile Individual Fast Phases Script Complete');
clear